...
namespace Tools { namespace Gfx { namespace Utils {
    ...
    void DeferredShading::_Render(Uint64 totalTime, _MeshList& meshes, Effect::Effect& (Material::Material::* getShader)())
    {
        //TODO: Alpha !
        ...
        if (beginShaderIt == meshes.end())
            return;
        auto current = &std::get<0>(*beginShaderIt)->GetGeometryShader();
    ...
    void DeferredShading::_RenderMeshes(Uint64 totalTime, _MeshList::iterator beginIt, _MeshList::iterator ite, Effect::Effect& shader)
    {
