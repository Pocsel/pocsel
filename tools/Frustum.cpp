...
namespace Tools {
    ...
    {
        this->_matrix = view;
        this->_planes[2].normal.x = -view[0][3] - view[0][0];
        this->_planes[2].normal.y = -view[1][3] - view[1][0];
        this->_planes[2].normal.z = -view[2][3] - view[2][0];
        this->_planes[2].d = -view[3][3] - view[3][0];
        this->_planes[3].normal.x = -view[0][3] + view[0][0];
        this->_planes[3].normal.y = -view[1][3] + view[1][0];
        this->_planes[3].normal.z = -view[2][3] + view[2][0];
        this->_planes[3].d = -view[3][3] + view[3][0];
        this->_planes[4].normal.x = -view[0][3] + view[0][1];
        this->_planes[4].normal.y = -view[1][3] + view[1][1];
        this->_planes[4].normal.z = -view[2][3] + view[2][1];
        this->_planes[4].d = -view[3][3] + view[3][1];
        this->_planes[5].normal.x = -view[0][3] - view[0][1];
        this->_planes[5].normal.y = -view[1][3] - view[1][1];
        this->_planes[5].normal.z = -view[2][3] - view[2][1];
        this->_planes[5].d = -view[3][3] - view[3][1];
        this->_planes[0].normal.x = -view[0][2];
        this->_planes[0].normal.y = -view[1][2];
        this->_planes[0].normal.z = -view[2][2];
        this->_planes[0].d = -view[3][2];
        this->_planes[1].normal.x = -view[0][3] + view[0][2];
        this->_planes[1].normal.y = -view[1][3] + view[1][2];
        this->_planes[1].normal.z = -view[2][3] + view[2][2];
        this->_planes[1].d = -view[3][3] + view[3][2];
        for (int i = 0; i < 6; i++)
        {
