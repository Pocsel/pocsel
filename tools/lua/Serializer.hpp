#ifndef __TOOLS_LUA_SERIALIZER_HPP__
#define __TOOLS_LUA_SERIALIZER_HPP__
...
namespace Tools { namespace Lua {
    ...
    public:
        ...
        Ref MakeSerializableCopy(Ref const& ref) const throw(std::runtime_error);
    private:
        Ref _Copy(Ref const& ref, std::list<Ref>& tables) const throw(std::runtime_error);
        Ref _CopySimpleValue(Ref const& ref) const throw(std::runtime_error);
