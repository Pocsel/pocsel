...
namespace Tools {
    ...
    struct ByteArray::Serializer<Renderers::Effect::CompleteShader>
    {
        ...
        static std::unique_ptr<Renderers::Effect::CompleteShader> Read(ByteArray& p)
        {
            return std::unique_ptr<Renderers::Effect::CompleteShader>(new Renderers::Effect::CompleteShader(p));
        }
