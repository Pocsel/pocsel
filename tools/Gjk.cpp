...
namespace Tools {
    ...
    bool Gjk::AddSupportPoint(glm::dvec3 const& newPoint)
    {
        int num = (Gjk::_bitsToIndices[this->_simplexBits ^ 15] & 7) - 1;
        this->_y[num] = newPoint;
        this->_yLengthSq[num] = glm::lengthSquared(newPoint);
        for (int num2 = Gjk::_bitsToIndices[this->_simplexBits]; num2 != 0; num2 >>= 3)
        {
            int num3 = (num2 & 7) - 1;
            glm::dvec3 vector = this->_y[num3] - newPoint;
            this->_edges[num3][num] = vector;
            this->_edges[num][num3] = -vector;
            this->_edgeLengthSq[num][num3] = (this->_edgeLengthSq[num3][num] = glm::lengthSquared(vector));
        }
    ...
    void Gjk::_UpdateDeterminant(int xmIdx)
    {
        ...
        while (num3 != 0)
        {
            ...
            int num6 = 1 << num5;
            int num7 = num6 | num;
            this->_det[num7][num5] = glm::dot(this->_edges[xmIdx][num5], this->_y[xmIdx]);
            this->_det[num7][xmIdx] = glm::dot(this->_edges[num5][xmIdx], this->_y[num5]);
            int num8 = num2;
            for (int i = 0; i < num4; i++)
            {
                ...
                this->_det[num11][num9] = this->_det[num7][num5] * glm::dot(this->_edges[num12][num9], this->_y[num5]) + this->_det[num7][xmIdx] * glm::dot(this->_edges[num12][num9], this->_y[xmIdx]);
                num12 = ((this->_edgeLengthSq[num9][num5] < this->_edgeLengthSq[xmIdx][num5]) ? num9 : xmIdx);
                this->_det[num11][num5] = this->_det[num10 | num][num9] * glm::dot(this->_edges[num12][num5], this->_y[num9]) + this->_det[num10 | num][xmIdx] * glm::dot(this->_edges[num12][num5], this->_y[xmIdx]);
                num12 = ((this->_edgeLengthSq[num5][xmIdx] < this->_edgeLengthSq[num9][xmIdx]) ? num5 : num9);
                this->_det[num11][xmIdx] = this->_det[num6 | num10][num9] * glm::dot(this->_edges[num12][xmIdx], this->_y[num9]) + this->_det[num6 | num10][num5] * glm::dot(this->_edges[num12][xmIdx], this->_y[num5]);
                num8 >>= 3;
            }
            num3 >>= 3;
            num4++;
        ...
        if ((this->_simplexBits | num) == 15)
        {
            ...
            this->_det[15][0] = this->_det[14][1] * glm::dot(this->_edges[num13][0], this->_y[1]) + this->_det[14][2] * glm::dot(this->_edges[num13][0], this->_y[2]) + this->_det[14][3] * glm::dot(this->_edges[num13][0], this->_y[3]);
            ...
            this->_det[15][1] = this->_det[13][0] * glm::dot(this->_edges[num13][1], this->_y[0]) + this->_det[13][2] * glm::dot(this->_edges[num13][1], this->_y[2]) + this->_det[13][3] * glm::dot(this->_edges[num13][1], this->_y[3]);
            ...
            this->_det[15][2] = this->_det[11][0] * glm::dot(this->_edges[num13][2], this->_y[0]) + this->_det[11][1] * glm::dot(this->_edges[num13][2], this->_y[1]) + this->_det[11][3] * glm::dot(this->_edges[num13][2], this->_y[3]);
            ...
            this->_det[15][3] = this->_det[7][0] * glm::dot(this->_edges[num13][3], this->_y[0]) + this->_det[7][1] * glm::dot(this->_edges[num13][3], this->_y[1]) + this->_det[7][2] * glm::dot(this->_edges[num13][3], this->_y[2]);
        }
    }
    ...
    glm::dvec3 Gjk::_ComputeClosestPoint()
    {
        double num = 0.0f;
        glm::dvec3 vector(0.0f);
        this->_maxLengthSq = 0.0f;
        for (int num2 = Gjk::_bitsToIndices[this->_simplexBits]; num2 != 0; num2 >>= 3)
        {
            int num3 = (num2 & 7) - 1;
