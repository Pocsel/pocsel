#ifndef __TOOLS_MODELS_CONVERT_UTILS_H__
#define __TOOLS_MODELS_CONVERT_UTILS_H__
...
#define loopvrev(v) for(int i = (v).length()-1; i>=0; i--)
    ...
    template <class T> struct vector
    {
        ...
        {
            ::Tools::Models::Convert::swap(buf, v.buf);
            ::Tools::Models::Convert::swap(ulen, v.ulen);
            ::Tools::Models::Convert::swap(alen, v.alen);
        }
