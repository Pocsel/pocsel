#ifndef __SERVER_MAPGEN_VALIDATORS_AYPLUSBINFERIORTOEQ_HPP__
#define __SERVER_MAPGEN_VALIDATORS_AYPLUSBINFERIORTOEQ_HPP__

#include "server/mapgen/Validator.hpp"

namespace Server { namespace MapGen { namespace Validators {

    class AYPlusBInferiorToEq : public Validator
    {
        private:
            double _a;
            double _b;
