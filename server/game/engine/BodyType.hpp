...
namespace Server { namespace Game { namespace Engine {
    ...
    private:
        ...
        static btCollisionShape* _BuildShape(Tools::Lua::Ref& lua);
        static btCollisionShape* _BuildBoxShape(Tools::Lua::Ref& lua);
        static btCollisionShape* _BuildSphereShape(Tools::Lua::Ref& lua);
    };
