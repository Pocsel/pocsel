    ...
    DoShit = function(self)
        ...
        if self.upupup then
            ...
            if d then
                ...
                Server.Doodad.SetInterPositionTarget(self.doodadPtr, "Turret", Utils.Vector3(0, 10, 0), 1000)
                Server.Doodad.SetInterAngleTarget(self.doodadPtr, "Turret", Utils.Vector3(-2, -2, -2), 0.1)
