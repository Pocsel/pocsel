...
//        this->_renderer.DrawElements(sizeof(indices), Tools::Renderers::DataType::UnsignedByte, indices, Tools::Renderers::DrawingMode::TrianglesStrip);
    ...
    void TargetedCubeRenderer::_InitVertexBuffer()
    {
        const float vertices[] = {
            ...
            1.02f, -0.02f, -0.02f,  0.0f, 0.0f,
            -0.02f, -0.02f, -0.02f,  1.0f, 0.0f,

            1.02f, 1.02f, -0.02f,  0.0f, 1.0f,
            1.02f, -0.02f, -0.02f,  0.0f, 0.0f,
            -0.02f, 1.02f, -0.02f,  1.0f, 1.0f,

            // back
            1.02f, 1.02f, 1.02f,  1.0f, 1.0f,
            -0.02f, -0.02f, 1.02f,  0.0f, 0.0f,
            1.02f, -0.02f, 1.02f,  1.0f, 0.0f,

            -0.02f, 1.02f, 1.02f,  0.0f, 1.0f,
            -0.02f, -0.02f, 1.02f,  0.0f, 0.0f,
            1.02f, 1.02f, 1.02f,  1.0f, 1.0f,

            // left
            -0.02f, 1.02f, 1.02f,  1.0f, 1.0f,
            -0.02f, -0.02f, -0.02f,  0.0f, 0.0f,
            -0.02f, -0.02f, 1.02f,  1.0f, 0.0f,

            -0.02f, 1.02f, -0.02f,  0.0f, 1.0f,
            -0.02f, -0.02f, -0.02f,  0.0f, 0.0f,
            -0.02f, 1.02f, 1.02f,  1.0f, 1.0f,

            // right
            1.02f, 1.02f, -0.02f,  1.0f, 1.0f,
            1.02f, -0.02f, 1.02f,  0.0f, 0.0f,
            1.02f, -0.02f, -0.02f,  1.0f, 0.0f,

            1.02f, 1.02f, 1.02f,  0.0f, 1.0f,
            1.02f, -0.02f, 1.02f,  0.0f, 0.0f,
            1.02f, 1.02f, -0.02f,  1.0f, 1.0f,
            ...
            1.02f, -0.02f, -0.02f,  0.0f, 1.0f,
            1.02f, -0.02f, 1.02f,  0.0f, 0.0f,
            -0.02f, -0.02f, -0.02f,  1.0f, 1.0f,

            // top
            -0.02f, 1.02f, 1.02f,  1.0f, 1.0f,
            1.02f, 1.02f, -0.02f,  0.0f, 0.0f,
            -0.02f, 1.02f, -0.02f,  1.0f, 0.0f,
