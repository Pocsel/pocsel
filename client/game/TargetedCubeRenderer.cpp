...
namespace Client { namespace Game {
    ...
    void TargetedCubeRenderer::_InitVertexBuffer()
    {
        const float vertices[] = {
            // front
            -0.02f, 1.02f, -0.02f,  0.0f, 0.0f,
            1.02f, 1.02f, -0.02f,  1.0f, 0.0f,
            1.02f, -0.02f, -0.02f,  1.0f, 1.0f,
            -0.02f, -0.02f, -0.02f,  0.0f, 1.0f,

            // back
            1.02f, 1.02f, 1.0f,  0.0f, 0.0f,
            -0.02f, 1.02f, 1.02f,  1.0f, 0.0f,
            -0.02f, -0.02f, 1.02f,  1.0f, 1.0f,
            1.02f, -0.02f, 1.02f,  0.0f, 1.0f,
        ...
        this->_vertexBuffer->SetData(6*4*3*sizeof(float) + 6*4*2*sizeof(float), vertices, Tools::Renderers::VertexBufferUsage::Static);
    }
