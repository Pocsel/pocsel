...
namespace Client { namespace Game {
    ...
    void TargetedCubeRenderer::_InitVertexBuffer()
    {
        const float vertices[] = {
            // front
            -0.02, 1.02, -0.02,  0.0, 0.0,
            1.02, 1.02, -0.02,  1.0, 0.0,
            1.02, -0.02, -0.02,  1.0, 1.0,
            -0.02, -0.02, -0.02,  0.0, 1.0,

            // back
            1.02, 1.02, 1.0,  0.0, 0.0,
            -0.02, 1.02, 1.02,  1.0, 0.0,
            -0.02, -0.02, 1.02,  1.0, 1.0,
            1.02, -0.02, 1.02,  0.0, 1.0,
